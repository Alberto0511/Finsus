      ...
      <table className="table-finsus">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="td-finsus">+ ${formatNumber(interesesGenerados)}</td>

            <td className="td3-finsus"> {Number.isNaN(interesesGenerados1)
                  ? interesesGenerados1
                  : interesesGenerados1 === "NA"
                    ? interesesGenerados1
                    : "+ $" + formatNumber(interesesGenerados1)}</td>

            <td className="td-finsus"> {Number.isNaN(interesesGenerados2)
                  ? interesesGenerados2
                  : interesesGenerados2 === "NA"
                    ? interesesGenerados2
                    : "+ $" + formatNumber(interesesGenerados2)}</td>
          </tr>

          <tr>
            <td className="td-finsus">% de crecimiento del dinero</td>
            <td className="td-finsus"> {Number.isNaN(crecimientodeDInero)
                  ? crecimientodeDInero
                  : crecimientodeDInero === "NA"
                    ? crecimientodeDInero
                    : formatNumber(crecimientodeDInero.toFixed(2) + "%")}</td>

            <td className="td3-finsus"> {Number.isNaN(crecimientodeDInero1)
                  ? crecimientodeDInero1
                  : crecimientodeDInero1 === "NA"
                    ? crecimientodeDInero1
                    : formatNumber(crecimientodeDInero1.toFixed(2) + "%")}</td>

            <td className="td-finsus"> {Number.isNaN(crecimientodeDInero2)
                  ? crecimientodeDInero2
                  : crecimientodeDInero2 === "NA"
                    ? crecimientodeDInero2
                    : "+" + formatNumber(crecimientodeDInero2.toFixed(2) + "%")}</td>
          </tr>
          <tr>
            <td className="td-finsus">Monto final</td>
            <td className="td-finsus">  ${formatNumber(montoFinal)}{" "}</td>
            <td className="td2-finsus"> {Number.isNaN(montoFinal1)
                  ? montoFinal1
                  : montoFinal1 === "NA"
                    ? montoFinal1
                    : "$" + formatNumber(montoFinal1)}</td>
            <td className="td-finsus"> {Number.isNaN(montoFinal2)
                  ? montoFinal2
                  : montoFinal2 === "NA"
                    ? montoFinal2
                    : "+ $" + formatNumber(montoFinal2)}</td>
          </tr>
        </tbody>
      </table>
    </div>
